...
namespace Kartavik\WhiteBIT\Api\Adapter;
...
final class Promise implements HttpPromise
{
    ...
    public function __construct(private PromiseInterface $promise, private RequestInterface $request)
    {
        ...
        $this->promise = $promise->then(function ($response) {
            ...
            if ($reason instanceof HttplugException) {
                ...
                $this->exception = new Exception\UnexpectedValueException('Reason returned from Guzzle6 must be an Exception');
            }
